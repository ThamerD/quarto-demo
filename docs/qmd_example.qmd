...
Additionally, note that in Table 1 we consider the sample standard deviation of the number of horses during the same time span as @fig-horses.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-sas width="60%"}

## Figure 2: Horse populations for the province with the largest standard deviation

In @fig-sas we zoom in and look at the province of {python largest_sd} which had the largest spread of values in terms of standard deviation.

# References

@Python @Allaire_Quarto_2022 @altair @click @horses1 @horses2 @knitr @pandas @ttimbers-horses
